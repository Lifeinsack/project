        ...
        <div id="box">
            ...
            <div id="order_content">
                <div id="box_head">
                    ...
                    <div>收货人：<input type="text"></div>
                    <div>收货人电话：<input type="tel"></div>
                    ...
                    <div><input id="search_down" value="查询结果导出" type="button"></div>
                </div>
                <div id="order_list">
                    <ul>
                        <li>
                        ...
                        <li>
                            ...
                            <div>
                                ...
                                <div class="order_goods_see">
                                    <h4 @click="ordertail(1,1)">查看售后</h4> 
                                    <h4>取消</h4>
                                </div>
                            </div>
                            </li>
      ...
      ordertail(id,type){
          if(type==0){
            this.$router.push({path:'/orderDetail',query:{id:id}})
              ...
              this.$router.push({path:'/applyBuyAfter',query:{id:id}})
          }
      }
  }
  }
